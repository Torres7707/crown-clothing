...
export const UserProvider = ({ children }) => {
	...
	useEffect(() => {
		// onAuthStateChangedListener is a function can listen to the auth state change,when the auth state change, it will call the callback function you pass in
